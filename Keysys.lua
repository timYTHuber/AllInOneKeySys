...
local Window = Library.CreateLib("ALLINONE KEYSYS", "DarkTheme") --This Will Make The Script Hub
...
function CorrectKeyAndLoadTheScript()
         loadstring(game:HttpGet(('https://raw.githubusercontent.com/timYTHuber/AllInOne/main/Hub.lua')))() --This Where You Put The Script That Will Be Loaded If The Key Is Correct
end
...
Section:NewButton("Copy Link", "ButtonInfo", function()
          		setclipboard("https://discord.gg/yteBp9uMte") --Put The Link Here
          OrionLib:MakeNotification({
                Name = "Copied Link!",
